    ...
    <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 md:py-4">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4 flex-1">
            ...
            <button id="mobileMenuBtn"
                class="md:hidden text-gray-600 hover:text-gray-900 p-2 rounded-md hover:bg-gray-100 transition">
                <i class="fas fa-bars text-xl"></i>
            </button>
            <!-- Page Title -->
            <h2 class="text-lg font-bold text-gray-800 truncate">
                @yield('page-title', 'Accounts Dashboard')
            </h2>
            <!-- Search Bar -->
            <div class="relative hidden sm:block flex-1 max-w-xs lg:max-w-md ml-4">
                <input
                    type="text"
                    placeholder="Search..."
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm bg-gray-50
        ...
        <div class="flex items-center space-x-3 sm:space-x-6">
            <!-- Notifications -->
            <button
                class="relative text-gray-500 hover:text-blue-600 p-2 transition focus:outline-none">
                <i class="far fa-bell text-xl"></i>
                <span
                    class="absolute top-1 right-1 w-2.5 h-2.5 bg-red-500 border-2 border-white rounded-full">
                </span>
            </button>
            <!-- Profile -->
            <div class="flex items-center space-x-3 cursor-pointer group">
                <img
                    ...
                    alt="Accounts"
                    class="w-9 h-9 sm:w-10 sm:h-10 rounded-full border-2 border-white shadow-sm
                           group-hover:border-blue-200 transition">
                <div class="hidden sm:block text-right">
                    <span class="block font-semibold text-gray-700 text-sm">
                        {{ auth()->user()->name ?? 'Accounts User' }}
                    </span>
