...
<head>
  ...
  <style>
    ...
    .input { width: 100%; padding: 10px 12px; font-size: 14px; border: 1px solid #e5e7eb; border-radius: 8px; background-color: #fff; }
    .input:read-only { background-color: #f9fafb; }
  </style>
</head>
