...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-8">
        ...
        <!-- Failed Leads Card -->
        <div class="bg-pink-400 p-4 rounded-lg shadow-sm border border-pink-400">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-pink-200 rounded-full flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.736 3h4.018a2 2 0 011.414.586l4.586 4.586a2 2 0 01.586 1.414v4.018a2 2 0 01-.586 1.414L14.142 19.142a2 2 0 01-1.414.586H8.736a2 2 0 01-1.789-1.106l-3.5-7A2 2 0 015.236 9H10V14z">
                            </path>
                        </svg>
                    </div>
                    <span class="text-xs font-bold text-white uppercase tracking-wider">
        ...
        <div class="bg-teal-600 p-4 rounded-lg shadow-sm border border-teal-600">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-teal-200 rounded-full flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Arrived Leads Card -->
        <div class="bg-sky-600 p-4 rounded-lg shadow-sm border border-sky-600">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center gap-2">
